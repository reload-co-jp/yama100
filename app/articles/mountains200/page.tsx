...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/articles/mountains200/" },
  openGraph: {
    title: "二百名山について",
    description: "日本二百名山の歴史と百名山との違いについての解説",
    url: "/articles/mountains200/",
    siteName: "Yama100",
    locale: "ja_JP",
    type: "article",
  },
...
const jsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "二百名山について", item: `${SITE_URL}/articles/mountains200/` },
  ],
}
...
const articleLd = {
  ...
  headline: "二百名山について",
  description: "日本二百名山の歴史と百名山との違いについての解説",
  url: `${SITE_URL}/articles/mountains200/`,
